...
description: Trail of Bits–style /goal security hunt. Native agentflow graph (Kimi CLI via OpenRouter on midkernel-dev ECS). Threat model, authored goals, fixed hunter fan-out, dual-pass judges, report.md.
surface: scan
